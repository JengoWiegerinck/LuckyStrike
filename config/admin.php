...
if (checkAdmin($user->getKlasse()))
{
    ?>
        ...
        <div class="h-56 grid gap-4 grid-cols-3 content-center">
            ...
            <input class="h-10 px-5 text-blackKleur transition-colors duration-150 border       border-blackKleur rounded-lg focus:shadow-outline hover:bg-redKleur   hover:text-whiteKleur hover:border-redKleur" type="button" value="medewerkeraccount"  onclick="window.location.href='horeca.php';"/>

            <input class="h-10 px-5 text-blackKleur transition-colors duration-150 border       border-blackKleur rounded-lg focus:shadow-outline hover:bg-redKleur   hover:text-whiteKleur hover:border-redKleur" type="button" value="klanten account"onclick="window.location.href='horeca.php';"/>
            ...
            <input class="h-10 px-5 text-blackKleur transition-colors duration-150 border       border-blackKleur rounded-lg focus:shadow-outline hover:bg-redKleur   hover:text-whiteKleur hover:border-redKleur" type="button" value="banen"onclick="window.location.href='horeca.php';"/>
